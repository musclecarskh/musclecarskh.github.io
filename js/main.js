...
/*------------------------------------------------------
  Javascript Function for filtering items
--------------------------------------------------------*/

  var FilterContainer = $('#gallery .filtr-container');
...
-------------------------------------------------------------------------*/
    ...
    $(form).on('submit',function(event) {
      ...
      window.open('mailto:contacts@musclecars.com.ua?subject=' + $('#name').val() + '&body=' + $('#message').val() + "\n\nEmail: " + $('#email').val());
